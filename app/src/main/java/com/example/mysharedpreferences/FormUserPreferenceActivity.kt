...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            ...
            val isLoveML = binding.rgLoveMl.checkedRadioButtonId == R.id.rb_yes
            if (name.isEmpty()) {
            ...
            saveUser (name, email, age, phoneNo, isLoveML)
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isloveML: Boolean) {
        val userPreference = UserPreference(this)
        userModel.name = name
        userModel.email = email
        userModel.age = Integer.parseInt(age)
        userModel.phone = phoneNo
        userModel.isLove = isloveML
